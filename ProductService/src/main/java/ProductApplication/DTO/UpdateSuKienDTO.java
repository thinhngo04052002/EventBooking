...
public class UpdateSuKienDTO {
	...
	public String toString() {
		return "UpdateSuKienDTO [AnhNenSuKien=" + AnhNenSuKien + ", TenSuKien=" + TenSuKien + ", TheLoai=" + TheLoai
	...
	public UpdateSuKienDTO(String anhNenSuKien, String tenSuKien, String theLoai, String anhSoDoGhe,
